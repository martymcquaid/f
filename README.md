...
- **Dev Server URL**: `http://127.0.0.1:5192`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/67fcacf6-d880-4ccf-8a59-3d8bd92bb6e7/preview`
- **Port**: `5192`
...
3. The dev server is accessible at `http://127.0.0.1:5192`
4. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/67fcacf6-d880-4ccf-8a59-3d8bd92bb6e7/preview`
5. All file changes will automatically reload in the browser via Vite HMR
